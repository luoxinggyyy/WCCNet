...
import argparse
import numpy as np
from models.WCCNet import EncoderTree
...
class WCCNet_decompose(nn.Module):
    def __init__(self, output_len, input_len, input_dim = 9, hid_size = 1, num_stacks = 1,
        ...
        super(WCCNet_decompose, self).__init__()
...
if __name__ == '__main__':
    ...
    model = WCCNet_decompose(output_len = args.horizon, input_len= args.window_size, input_dim = 9, hid_size = args.hidden_size, num_stacks = 1,
