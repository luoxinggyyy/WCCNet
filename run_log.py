...
from experiments.exp_LOG import exp_LOG

parser = argparse.ArgumentParser(description='WCCNet on well log dataset')

well_pred = 'CNL'##需要预测的测井曲线
parser.add_argument('--model', type=str, required=False, default='WCCNet', help='model of the experiment')
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='log1')
parser.add_argument('--root_path', type=str, default='./datasets/well-log-data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='well-log.csv', help='location of the data file')
parser.add_argument('--features', type=str, default='S', choices=['S', 'M'], help='features S is univariate, M is multivariate')
parser.add_argument('--target', type=str, default=well_pred , help='U,TH,AC,PE,GR,SP,CNL')
...
parser.add_argument('--inverse', type=bool, default =False, help='x')
parser.add_argument('--embed', type=str, default='timeF', help='time features encoding, options:[timeF, fixed, learned]')
parser.add_argument('--start_path', type=int, default='3800', help='well log bigin')
parser.add_argument('--end_path', type=int, default='3830', help='well log ending')
...
parser.add_argument('--lr', type=float, default=0.007, help='optimizer learning rate')
...
parser.add_argument('--model_name', type=str, default='WCCNet')
parser.add_argument('--resume', type=bool, default=False)
parser.add_argument('--evaluate', type=bool, default=False) ##有训练好的就点ture，不然就点false

### -------  model settings --------------  
parser.add_argument('--hidden-size', default=8, type=float, help='hidden channel of module')
...
data_parser = {
    'log1': {'data': 'well-log.csv', 'T': well_pred , 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
}
